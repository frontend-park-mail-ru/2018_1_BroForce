...
var _Route = __webpack_require__(342);
...
var _MainComponent2 = __webpack_require__(11);
...
var Main = function (_MainComponent) {
    ...
    function Main() {
        ...
        return _possibleConstructorReturn(this, (Main.__proto__ || Object.getPrototypeOf(Main)).call(this, 'div', ['menu'], {}));
    }

    _createClass(Main, [{
        key: 'build',
        value: function build() {
            this.append(new _Block2.default('p', 'NEON LIGHT', ['menu-logo'], {}).render());
...
var Menu = function (_MainComponent) {
    ...
    function Menu(data) {
        ...
        var _this = _possibleConstructorReturn(this, (Menu.__proto__ || Object.getPrototypeOf(Menu)).call(this, 'div', [], {}));
...
var _Validator = __webpack_require__(345);
...
var Form = function (_MainComponent) {
    ...
    function Form(data) {
        ...
        data.fields.forEach(function (field) {
            _this.append(new _Block2.default('div', '', ['error'], { name: field.name }).render());
            _this.append(new _Input2.default(field.type, field.id, field.name, field.class, field.placeholder).render());
        });

        _this.backBtn = new _Button2.default(data.button.text, ['btnDiv'], data.button.id).render();
        ...
        _this.errorFields = [].concat(_toConsumableArray(_this.render().getElementsByClassName('error')));
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(97), __webpack_require__(336)(module)))
...
var _ServiceWorkerRegister = __webpack_require__(343);
...
var _signUp = __webpack_require__(346);

var _signUp2 = _interopRequireDefault(_signUp);

var _Leaderboard = __webpack_require__(347);

var _Leaderboard2 = _interopRequireDefault(_Leaderboard);

var _Profile = __webpack_require__(349);

var _Profile2 = _interopRequireDefault(_Profile);

var _About = __webpack_require__(350);
...
_UserService2.default.GetData().catch(function (response) {
    ...
    loading.remove();
    _Router2.default.use('/', _Main2.default).use('/signin/', _signIn2.default).use('/signup/', _signUp2.default).use('/leaderboard/', _Leaderboard2.default).use('/profile/', _Profile2.default).use('/about/', _About2.default).start();
});
...
var SignIn = function (_MainComponent) {
    ...
    function SignIn() {
        ...
        return _possibleConstructorReturn(this, (SignIn.__proto__ || Object.getPrototypeOf(SignIn)).call(this, 'form', ['login'], {}));
    }

    _createClass(SignIn, [{
        key: 'build',
        value: function build() {
            this.append(new _Block2.default('p', 'Sign in', ['form-input'], {}).render());
            this.append(new _Form2.default(data).render());
            this.append(new _Button2.default('Back', ['btnDiv'], 'signInBackBtn').render());
            document.getElementById('main').appendChild(this.render());
...
var SignUp = function (_MainComponent) {
    ...
    function SignUp() {
        ...
        return _possibleConstructorReturn(this, (SignUp.__proto__ || Object.getPrototypeOf(SignUp)).call(this, 'div', ['login'], {}));
    }

    _createClass(SignUp, [{
        key: 'build',
        value: function build() {
            this.append(new _Block2.default('p', 'Sign up', ['form-input'], {}).render());
            this.append(new _Form2.default(data).render());
            this.append(new _Button2.default('Back', ['btnDiv'], 'signUpBackBtn').render());
            document.getElementById('main').appendChild(this.render());
...
var Leaderboard = function (_MainComponent) {
    ...
    function Leaderboard() {
        ...
        var _this = _possibleConstructorReturn(this, (Leaderboard.__proto__ || Object.getPrototypeOf(Leaderboard)).call(this, 'div', ['leaderBoard'], {}));
    ...
    _createClass(Leaderboard, [{
        ...
        value: function build() {
            ...
            this.GetUsersFromBack(this.usersOnLeaderBoard, 0).catch(function (response) {
                ...
                _this2.usersTable = new _Block2.default('p', _this2.pagination(_this2.usersFromBack), [], {});
                ...
                _this2.append(new _Button2.default('Back', ['btnDiv'], 'leaderBoardBackBtn').render());
...
var Pagination = function (_MainComponent) {
    ...
    function Pagination(countOfPages) {
        ...
        var _this = _possibleConstructorReturn(this, (Pagination.__proto__ || Object.getPrototypeOf(Pagination)).call(this, 'div', ['pagination'], attrs));
        ...
        _this.append(new _Block2.default('a', '<<', [], {}).render());
        _this.append(new _Block2.default('a', 1, ['active'], {}).render());
        for (var i = 1; i < _this.countOfPages; i++) {
            _this.append(new _Block2.default('a', i + 1, [], {}).render());
        }
        _this.append(new _Block2.default('a', '>>', [], {}).render());
        return _this;
    }
...
var Profile = function (_MainComponent) {
    ...
    function Profile() {
        ...
        return _possibleConstructorReturn(this, (Profile.__proto__ || Object.getPrototypeOf(Profile)).call(this, 'div', ['profile'], { style: 'margin-top: 2%' }));
    }
    ...
    _createClass(Profile, [{
        ...
        value: function build() {
            ...
            this.append(new _ImageComp2.default('../img/user-default.jpg', [], 'logo').render());

            this.title = new _Block2.default('p', 'Hello, ' + name + '!', ['form-input'], {});
            this.append(this.title.render());

            this.changeLoginInput = new _MainComponent3.default('input', ['form-input', 'profile-input'], { name: 'changeLoginInput', value: this.userData.name, placeholder: 'Enter name' });
            this.append(this.changeLoginInput.render());

            this.changeEmailInput = new _MainComponent3.default('input', ['form-input', 'profile-input'], { name: 'changeEmailInput', value: this.userData.email, placeholder: 'Enter email' });
            this.append(this.changeEmailInput.render());

            this.password = new _MainComponent3.default('input', ['form-input', 'profile-input'], { type: 'hidden', id: 'password', name: 'password', placeholder: 'Enter password' });
            this.append(this.password.render());

            this.append(new _Button2.default('Change avatar', ['btnDiv'], 'changeAvatarBtn').render());

            this.buttonBack = new _Button2.default('Back', ['btnDiv'], 'profileBackBtn');
        ...
        value: function initEvents() {
            ...
            this.changeLoginInput.render().onfocus = function () {
                ...
                _this2.buttonBack.render().innerHTML = 'Save and quit';
            };
            ...
            this.buttonBack.render().addEventListener('click', function () {
                var newData = [].concat(_toConsumableArray(document.getElementsByClassName('profile-input')));
                ...
                if (backWay !== null) {
                    ...
                    _Trasport2.default.Post(backWay, body).catch(function (response) {
                        ...
                        _UserService2.default.GetData().then(function () {
                            ...
                            _this2.buttonBack.render().innerHTML = 'Back';
                            _this2.title.innerHTML('Hello, ' + _UserService2.default.GetUser().login + '!');
                            _Router2.default.go('/');
                        });
                    });
                } else {
...
var About = function (_MainComponent) {
    ...
    function About() {
        ...
        return _possibleConstructorReturn(this, (About.__proto__ || Object.getPrototypeOf(About)).call(this, 'div', ['about'], {}));
    }

    _createClass(About, [{
        key: 'build',
        value: function build() {
            var aboutText = 'Neon light - it is web game about neon and fights! Developed by BroForce team.';
            this.append(new _Block2.default('p', aboutText, ['form-input'], {}).render());
            this.append(new _Button2.default('Back', ['btnDiv'], 'AboutBackBtn').render());
            document.getElementById('main').appendChild(this.render());
...
var _UL = __webpack_require__(352);
